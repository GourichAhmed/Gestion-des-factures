...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Utilisateur | Ajouter Produit</title>
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Ajouter Produit</div>
                    </div>
                    <div class="col s12 m12 l6">
                        <div class="card">
                            <div class="card-content">
                                ...
                                <div class="row">
                                    <form class="col s12" action="upload.php" name="chngpwd" method="post" enctype="multipart/form-data">
                                          <?php if($error){?><div class="errorWrap"><strong>ERROR</strong> : <?php echo htmlentities($error); ?> </div><?php } 
                                                else if($msg){?><div class="succWrap"><strong>SUCCESS</strong> : <?php echo htmlentities($msg); ?> </div><?php }?>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input id="leavetype" type="text"  class="validate" autocomplete="off" name="designation"  required>
...
<button type="submit" name="add" class="waves-effect waves-light btn  m-b-xs">Ajouter</button>
